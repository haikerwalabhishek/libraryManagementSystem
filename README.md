...
## Features
- **Add Books**: You can add books, but the data isn't stored in local storage.
- **Search**: Search for books by title or author.
- **Navigation**: Navigate through multiple pages seamlessly, with no loading interruptions.
